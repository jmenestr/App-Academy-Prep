...
describe "ComputerPlayer" do
  ...
  describe "get_move" do
    ...
    context "when a fork move is aviailable" do 
      it "should return the move which makes a fork" do 
        place_marks([[1,0],[2,1]],:X)
        place_marks([[2,0],[2,2]],:O)
        comp.mark = :O
        comp.display(board)

        expect([[1,2],[0,2]]).to include(comp.get_move)
      end
    end
