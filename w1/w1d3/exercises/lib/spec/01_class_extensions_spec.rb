require "rspec"
require_relative "../01_class_extensions"
...
describe String do
  describe "#caesar" do
    ...
    it "encodes a word with all capital letter" do
    expect("AAA".caesar(1)).to eq("BBB")
   end

    it "encodes a word with a mix of letter cases" do
    expect("AbCdEfG".caesar(3)).to eq("DeFgHiJ")
   end
